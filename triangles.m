...
blaze = 19.4;       
L1=40; % number of grating strata (for "staircase" approximation)
m_max=5; % max diffraction order index
...
grating.d21=d*cos(zeta); % first grating period: x2 projection - d
grating.d31=d*sin(zeta); % first grating period: x3 projection - 0
grating.d22=d; % second grating period: x2 projection - 0
grating.d32=0; % second grating period: x3 projection - d
grating.stratum={};
